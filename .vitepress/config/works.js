export default {
  ...
  list: [
    ...
    },
    {
      top: 2,
      title: 'EasyPicker(轻取)',
      description: '在线文件收集系统，支持各种文件的收集，一站式存储，提交者无需注册',
      time: {
        start: '2019/03/27',
      },
      github: {
      ...
      cover: 'https://img.cdn.sugarat.top/mdImg/MTY3ODAwMzU3MTc2Ng==678003571766',
      tags: ['Vue'],
      links: [
        {
          title: '提交示例',
    ...
    },
    {
      ...
      tags: ['Vue'],
      cover: 'https://img.cdn.sugarat.top/mdImg/sugar/d1b087516b60642d9556c470919e6b0b',
    },
  ],
}
