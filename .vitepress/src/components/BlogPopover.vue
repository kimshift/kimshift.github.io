...
<template>
    ...
    <div class="header">
      <div class="title-wrapper">
        <ElIcon size="20px">
          ...
          <svg v-else t="1716085184855" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
            p-id="4274" width="200" height="200">
            <path
  ...
  <div v-show="!show && (popoverProps?.reopen ?? true) && popoverProps?.title" class="theme-blog-popover-close"
    :class="{ twinkle: !show && (popoverProps?.twinkle ?? true) }" @click="show = true">
    <ElIcon>
      <i v-if="popoverProps?.icon" v-outer-html="popoverProps.icon" />
      <svg v-else t="1716085184855" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4274"
