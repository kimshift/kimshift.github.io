...
![image-20210218010732328](https://www.file.kim-shift.cn/markdown/image-20210218010732328.png)
...
3. 一旦执行栈中的所有同步任务执行完毕，系统就会按次序读取**任务队列**中的异步任务，于是被读取的异步任 务结束等待状态，进入执行栈，开始执行。
   ![image-20210218165354752](https://www.file.kim-shift.cn/markdown/image-20210218165354752.png)
