<template>
  <div id="boxx">
    <div :class="class_boxx" :style="style_boxx" v-if="!text">
      <p
...
export default {
  ...
  methods: {
    async getContent(callback) {
      if (this.list.length >= 100) return callback && callback();
...
const list = [
  ...
  {
    title: '康德',
    content: '自由不是让你想做什么就做什么，自由是教你不想做什么，就可以不做什么。',
  },
  ...
  {
    title: '友人c',
    content: '这个世界上没有忽然崩溃的感情，只有压弯骆驼的最后一根稻草。',
  },
  {
    title: '媳妇儿',
    content: '心里有我，想着我，有什么事告诉我，不要让我问，不要让我等。',
  },
];
</script>
